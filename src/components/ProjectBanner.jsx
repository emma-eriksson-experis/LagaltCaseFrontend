                ...
                <div className="flex space-x-2">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex space-x-2 pt-4 font-bold h-full items-end"> 
                            {
                                project.projectSkills.split(',').map((skill, index) => {
                                    if (user && user.userSkills.includes(skill)) {
                                        return <span key={index} className="bg-green-400 text-sm rounded-full px-2">{skill}</span>
                                    } else {
                                        return <span key={index} className="bg-gray-300 text-sm rounded-full px-2">{skill}</span>
                                    }
                                })
                            }
                        </div>    
